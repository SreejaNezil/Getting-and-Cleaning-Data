...
** [2] Activity.Names** - Factor with 6 levels
...
**Feature selection for the experiment**
...
The mean and standard deviation was then calculated for all these variables

These mean and standard deviation values are then grouped by the SubjectID and type of Activity performed.
The average is calculated for each such group, resulting in the following columns
